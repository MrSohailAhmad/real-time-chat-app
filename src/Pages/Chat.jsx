  ...
  return (
    <div onClick={() => showEmojis && setShowEmojis(false)}>
      ...
      <div className="container mt-4 mb-5">
        ...
        <div className="row chat-sec justify-content-between mt-3">
              ...
              user.users[0]._id === `${UserID()}` ? (
                ...
                >
                  <Contact
                    ...
                    time={
                      user.latestMessage ? (
                        <Moment fromNow>{user.latestMessage.updatedAt}</Moment>
                      ) : (
                        ""
                      )
                    }
              ...
              {messages.map((message, i) =>
                message.sender._id === `${UserID()}` ? (
                  <Message
                    ...
                    time={<Moment format="HH:mm">{message.createdAt}</Moment>}
                  />
                ) : (
                  <Message
                    key={i}
