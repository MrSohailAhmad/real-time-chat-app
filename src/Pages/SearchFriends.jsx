    ...
    <div>
      ...
      <div className="container mt-4">
        ...
        <div className="row justify-content-around mt-5 mb-5">
          {users.map((user) => (
            <div
              className="card border-0 bg-white shadow rounded-4 mt-4"
              style={{ width: "26rem" }}
              key={user._id}
            >
              <div className="row d-flex align-items-center justify-content-between">
                ...
                <div className="col-md-4 py-3">
                  <Link
                    ...
                    state={{ id: user._id }}
                    className="btn w-100 button-secondary text-white no-hover"
                  >
                  ...
                  <button
                    ...
                    id={user._id}
                    className="btn w-100 button-primary text-white mt-2 no-hover"
                  >
